...
export default function Edit( { attributes, setAttributes, clientId } ) {
	const { title, faqItems } = attributes;
	const blockProps = useBlockProps( { className: 'container lc-tidyjs2026-editor-block' } );

	return (
		<EditorBlockShell blockProps={ blockProps } clientId={ clientId } title="LC Blog FAQ" textDomain="lc-tidyjs2026">
			<TextControl
			...
			/>
			<RepeaterField
				label={ __( 'Questions', 'lc-tidyjs2026' ) }
				value={ faqItems }
