...
<section <?php echo $wrapper_attributes; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- get_block_wrapper_attributes() already escapes. ?>>
	<div class="container py-5">
		...
		<div class="row justify-content-center gap-5">
			<div class="col-12 col-md-4 mx-auto my-4" data-reveal="up">
			...
			<div class="col-12 col-md-4 mx-auto my-4" data-reveal="up" data-reveal-delay="200">
			...
			<div class="col-12 col-md-4 mx-auto my-4" data-reveal="up" data-reveal-delay="400">
