...
function lc_tidyjs2026_register_post_types() {
	...
	// Ported from lc-tidy2026 (inc/lc-posttypes.php). No 'editor' support and
	// show_in_rest false by design — this CPT dispenses with the block
	// editor entirely; quote/location are plain meta fields edited through
	// a classic metabox (see lc_tidyjs2026_testimonial_metabox() below).
	register_post_type(
		'testimonial',
		array(
			'labels'          => array(
